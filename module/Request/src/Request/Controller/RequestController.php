...
//         var_dump($queueData);
    ...
    private function outputReportManagerActionNeeded( $spreadsheetRows = [] )
    {
        ...
        $worksheet->setCellValue('F1', 'Request Reason');
        ...
        foreach($spreadsheetRows as $key => $spreadsheetRow)
        {
            ...
            $worksheet->setCellValue('B'.($key+2), $spreadsheetRow['EMPLOYEE_DESCRIPTION_ALT']);
            ...
            $worksheet->setCellValue('F'.($key+2), $spreadsheetRow['REQUEST_REASON']);
