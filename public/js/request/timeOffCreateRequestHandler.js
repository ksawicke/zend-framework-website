...
var timeOffCreateRequestHandler = new function() {
	...
	selectedDatesApproved = [], selectedDateCategoriesApproved = [], selectedDateHoursApproved = [],
		...
		$(document).on(
				...
				function() {
					...
					if (selectedTimeoffCategory !== null
						...
						timeOffCreateRequestHandler.updateRequestDates(
								dateObject, $(this));
					}
				});
	}
	...
	this.drawThreeCalendars = function(calendarData) {
		...
		$("#calendarNavigationFastRewind").attr("data-month",
				calendarData.navigation.calendarNavigationFastRewind.month);
		$("#calendarNavigationFastRewind").attr("data-year",
				calendarData.navigation.calendarNavigationFastRewind.year);
		$("#calendarNavigationRewind").attr("data-month",
				calendarData.navigation.calendarNavigationRewind.month);
		$("#calendarNavigationRewind").attr("data-year",
				calendarData.navigation.calendarNavigationRewind.year);
		$("#calendarNavigationFastForward").attr("data-month",
				calendarData.navigation.calendarNavigationFastForward.month);
		$("#calendarNavigationFastForward").attr("data-year",
				calendarData.navigation.calendarNavigationFastForward.year);
		$("#calendarNavigationForward").attr("data-month",
				calendarData.navigation.calendarNavigationForward.month);
		$("#calendarNavigationForward").attr("data-year",
				calendarData.navigation.calendarNavigationForward.year);
...
//	}
	...
	this.selectCategory = function(categoryButton) {
		...
		if (categoryButton.hasClass('disableTimeOffCategorySelection')
				&& categoryButton.hasClass('categoryPTO')) {
	...
	this.updateRequestDates = function(object, calendarDateObject) {
		...
		if (copy === null && deleteKey === null) {
			timeOffCreateRequestHandler.addDataToRequest(calendarDateObject,
					object);
		}
		 ...
		 */
		if (copy == null && deleteKey !== null) {
			timeOffCreateRequestHandler.deleteDataFromRequest(
					calendarDateObject, deleteKey, object);
		}
		 ...
		 */
		if (copy !== null && deleteKey !== null) {
			timeOffCreateRequestHandler.splitDataFromRequest(
					calendarDateObject, deleteKey, copy, newOne);
		}
	...
	this.deleteDataFromRequest = function(calendarDateObject, deleteKey, object) {
		timeOffCreateRequestHandler.subtractTime(
				selectedDatesNew[deleteKey].category,
	...
	this.splitDataFromRequest = function(calendarDateObject, deleteKey, copy,
			newOne) {
		timeOffCreateRequestHandler.subtractTime(copy.category,
				Number(copy.hours));
		timeOffCreateRequestHandler.removeDateFromRequest(deleteKey);
