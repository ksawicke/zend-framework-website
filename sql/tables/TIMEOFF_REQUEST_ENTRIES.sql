...
--  Generated on:              	09/02/16 15:11:26 
--  Relational Database:       	SWIFTDB 
--  Standards Option:          	DB2 for i 
CREATE TABLE HRTEST/TIMEOFF_REQUEST_ENTRIES FOR SYSTEM NAME TOENTRY ( 
...
ON HRTEST/TIMEOFF_REQUEST_ENTRIES TO ALDONCMS WITH GRANT OPTION ; 
  
GRANT SELECT   
ON HRTEST/TIMEOFF_REQUEST_ENTRIES TO PUBLIC ; 
  
GRANT ALTER , DELETE , INDEX , INSERT , REFERENCES , SELECT , UPDATE   
ON HRTEST/TIMEOFF_REQUEST_ENTRIES TO S2KOBJOWNR WITH GRANT OPTION ; 
