...
--  Generated on:              	08/31/16 14:20:15 
--  Relational Database:       	SWIFTDB 
--  Standards Option:          	DB2 for i 
CREATE TABLE SAWIK2/TIMEOFF_REQUEST_SETTINGS FOR SYSTEM NAME TOSETTING ( 
	IDENTITY_ID FOR COLUMN IDENTITYID DECIMAL(13, 0) GENERATED ALWAYS AS IDENTITY ( 
	...
	CREATE_TIMESTAMP FOR COLUMN CTCRTTIM   TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , 
	...
	CONSTRAINT SAWIK2/Q_SAWIK2_TOSETTING_IDENTITYID_00001 PRIMARY KEY( IDENTITY_ID ) )   
	  
	RCDFMT SPDSETT1   ; 
  
GRANT ALTER , DELETE , INDEX , INSERT , REFERENCES , SELECT , UPDATE   
ON SAWIK2/TIMEOFF_REQUEST_SETTINGS TO S2KOBJOWNR WITH GRANT OPTION ;
